<div class="form-container">
    ...
    <div class="form-group">
        ...
        [select* fasciaprezzo id:fascia-prezzo-pneumatico first_as_label "- - Fascia Prezzo Pneumatico - -" "CLASSE T1 PREMIUM" "CLASSE T2 MEDIUM" "CLASSE T3 ECONOMY" "CLASSE T5 LE NOSTRE PROPOSTE"]
    </div>
...
<!-- Gli script JS sono stati spostati nel plugin "Custom CSS & JS" -->
<style>
    .form-container {
        display: flex;
