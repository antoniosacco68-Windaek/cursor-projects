<div class="form-container">
    ...
    <div class="form-group">
      <label for="tipo-preventivo">Tipologia preventivo</label>
        [select* selected_tipo_preventivo id:tipo-preventivo class:preventivo-selector first_as_label "- - Tipologia preventivo - -" "PREVENTIVO PNEUMATICI NUOVI/USATI" "PREVENTIVO MECCANICA" "PREVENTIVO PNEUMATICI MOTO"]
    </div>
    <div class="preventivo-group preventivo_pneumatici hidden">
        ...
        <div class="form-group">
           ...
           [select fasciaprezzo id:fascia-prezzo-pneumatico first_as_label "- - Fascia Prezzo Pneumatico - -" "GOMME NUOVE BASSO PREZZO" "GOMME NUOVE FASCIE MEDIE" "GOMME NUOVE FASCIE ALTE" "GOMME USATE"]
        </div>
    </div>
    ...
    <div class="form-group">
         <label for="negozio">Seleziona un negozio</label>
...
document.addEventListener('DOMContentLoaded', updateTireSelects);
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function togglePreventivoGroups() {
        ...
        if (selectedValue === 'PREVENTIVO PNEUMATICI NUOVI/USATI') {
